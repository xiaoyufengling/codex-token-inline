...
[assembly: AssemblyInformationalVersion("0.2.0-alpha.4")]
static class NativeLauncher {
    const string Version="0.2.0-alpha.4";
    ...
    static void Manage(){
        using(var form=new Form()){
            form.Text="Codex Token Inline";form.ClientSize=new Size(520,340);
            ...
            refresh();form.Controls.AddRange(new Control[]{text,author,credit,languageLabel,language,note,open,uninstall});Application.Run(form);
        }
    }
}
